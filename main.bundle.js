...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_22__change_password_change_password_component__ = __webpack_require__("./src/app/change-password/change-password.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_23__posts_posts_component__ = __webpack_require__("./src/app/posts/posts.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_24__github_followers_github_followers_component__ = __webpack_require__("./src/app/github-followers/github-followers.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_25__navbar_navbar_component__ = __webpack_require__("./src/app/navbar/navbar.component.ts");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_28__github_profile_github_profile_component__ = __webpack_require__("./src/app/github-profile/github-profile.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_29__not_found_not_found_component__ = __webpack_require__("./src/app/not-found/not-found.component.ts");
...
AppModule = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_11__angular_core__["b" /* NgModule */])({
        declarations: [
            ...
            __WEBPACK_IMPORTED_MODULE_22__change_password_change_password_component__["a" /* ChangePasswordComponent */],
            __WEBPACK_IMPORTED_MODULE_23__posts_posts_component__["a" /* PostsComponent */],
            __WEBPACK_IMPORTED_MODULE_24__github_followers_github_followers_component__["a" /* GithubFollowersComponent */],
            ...
            __WEBPACK_IMPORTED_MODULE_28__github_profile_github_profile_component__["a" /* GithubProfileComponent */],
            __WEBPACK_IMPORTED_MODULE_29__not_found_not_found_component__["a" /* NotFoundComponent */],
        ],
        imports: [
            ...
            __WEBPACK_IMPORTED_MODULE_26__angular_router__["a" /* RouterModule */].forRoot([
                { path: '', component: __WEBPACK_IMPORTED_MODULE_27__home_home_component__["a" /* HomeComponent */] },
                { path: 'followers/:id/:username', component: __WEBPACK_IMPORTED_MODULE_28__github_profile_github_profile_component__["a" /* GithubProfileComponent */] },
                { path: 'followers', component: __WEBPACK_IMPORTED_MODULE_24__github_followers_github_followers_component__["a" /* GithubFollowersComponent */] },
                { path: 'posts', component: __WEBPACK_IMPORTED_MODULE_23__posts_posts_component__["a" /* PostsComponent */] },
                { path: '**', component: __WEBPACK_IMPORTED_MODULE_29__not_found_not_found_component__["a" /* NotFoundComponent */] }
            ])
        ],
        providers: [
...
module.exports = "<h1> BETA</h1>\n\n<form>\n  <div class=\"form-group\">\n    <input #test type=\"email\" class=\"form-control\" id=\"exampleInputEmail1\" aria-describedby=\"emailHelp\" placeholder=\"Enter username\">\n    <small id=\"emailHelp\" class=\"form-text text-muted\">We'll never share your search with anyone else.</small>\n  </div>\n  <button (click)=\"searchX(test.value)\" class=\"btn btn-primary\">Submit</button>\n</form>\n\n\n\n<div *ngFor=\"let follower of followers\" class=\"media\">\n  <div class=\"media-left\">\n    <a href=\"#\">\n      <img class=\"avatar media-object\" src=\"{{ follower.avatar_url }}\" alt=\"...\">\n    </a>\n  </div>\n  <div class=\"media-body\">\n    <h4 class=\"media-heading\">\n      <a [routerLink]=\"['/followers',follower.id, follower.login]\">{{ follower.login }}</a>\n    </h4>\n    <a href=\"follower.html_url\">{{ follower.html_url }}</a>\n  </div>\n</div>\n\n <div *ngIf=\" followers && followers.length == 0\"> No followers!</div>\n"
...
var GithubFollowersComponent = (function () {
    ...
    GithubFollowersComponent.prototype.searchX = function (mystring) {
        var _this = this;
        ...
        obs.
            ...
            return _this.service.getAll(mystring);
        })
            .subscribe(function (followers) { _this.followers = followers; });
    };
    GithubFollowersComponent.prototype.ngOnInit = function () {
        ...
        obs.
            ...
            var page = combined[1].get('page');
            //this.service.getAll({id: id, page: page})
            return _this.service.getAll('engineer-only');
        })
            .subscribe(function (followers) { _this.followers = followers; });
    };
...
var DataService = (function () {
    ...
    DataService.prototype.getAll = function (mystring) {
        return this.http.get('https://api.github.com/users/' + mystring + '/followers')
